...
# a5..a0 as digital io for rgb_led_a5_a0_tri_io[5:0]
#set_property -dict {PACKAGE_PIN L15 IOSTANDARD LVCMOS33} [get_ports {gpio_rgb_led_a5_a0_tri_io[5]}]
#set_property -dict {PACKAGE_PIN G17 IOSTANDARD LVCMOS33}  [get_ports {gpio_rgb_led_a5_a0_tri_io[4]}]
#set_property -dict {PACKAGE_PIN N15 IOSTANDARD LVCMOS33} [get_ports {gpio_rgb_led_a5_a0_tri_io[3]}]
#set_property -dict {PACKAGE_PIN G14 IOSTANDARD LVCMOS33} [get_ports {gpio_rgb_led_a5_a0_tri_io[2]}]
#set_property -dict {PACKAGE_PIN L14 IOSTANDARD LVCMOS33} [get_ports {gpio_rgb_led_a5_a0_tri_io[1]}]
#set_property -dict {PACKAGE_PIN M15 IOSTANDARD LVCMOS33} [get_ports {gpio_rgb_led_a5_a0_tri_io[0]}]
